...
<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-lg">
      <form action="{{route('user.store')}}" method="POST" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
        @csrf
        ...
        @endif
        <p class="text-center text-lg font-medium">Data User</p>
        ...
        <div>
          <div class="relative">
            <select name="role" id="role" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm">
                <option selected hidden disabled class="block rounded-lg px-4 py-2 text-sm text-gray-500 hover:bg-gray-50 hover:text-gray-700">Beri Role</option>
