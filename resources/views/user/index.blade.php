    ...
    <table class="border border-gray-200 min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
        ...
        <tbody class="divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">{{$item['email']}}</td>
                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">{{$item['role']}}</td>
                <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">{{$item['password']}}</td>
