        ...
        <body>
            ...
            <div id="page-container">
                <div id="pf1" class="pf w0 h0" data-page-no="1">
                    <div class="pc pc1 w0 h0">                        <div class="t m0 x1 h2 y1 ff1 fs0 fc0 sc0 ls0 ws0">SURAT PERNYATAAN</div>
                        ...
                        <div class="t m0 x3 h2 y5 ff1 fs0 fc0 sc0 ls0">NAMA:{{$item['name']}}</div>
                        <div class="t m0 x3 h2 y6 ff1 fs0 fc0 sc0 ls0 ws0">ROMBEL :{{$item['rombel_id']}}</div>
                        <div class="t m0 x3 h2 y7 ff1 fs0 fc0 sc0 ls0 ws0">RAYON :{{$item['rayon_id']}}</div>
                        ...
                        <div class="t m0 x8 h2 y11 ff1 fs0 fc0 sc0 ls0 ws0">({{$item['name']}} )</div>
                        <div class="t m0 x9 h2 y12 ff1 fs0 fc0 sc0 ls0 ws0">Pembimbing Siswa</div>
                        <div class="t m0 x8 h2 y13 ff1 fs0 fc0 sc0 ls0 ws0">( {{$rayon['user_id']}} )</div>
                        ...
                        <div class="t m0 xb h2 y16 ff1 fs0 fc0 sc0 ls0">
                        <a href="{{ route('ps.rekap')}}">Kembali</a>
                        <a href="{{ route('ps.download',$item['id'])}}">Download</a>
                        <a href="javascript:printPdf()">Print</a>
                        </div>
                    </div>
